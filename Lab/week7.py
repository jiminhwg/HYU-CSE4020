...
def main():
    ...
    #red_arm = Node(base, glm.translate((.5,0,.01)) * glm.scale((.25,.1,0.)), glm.vec3(1,0,0))
    #green_arm = Node(red_arm, glm.translate((.5,0,.01)) * glm.scale((.25,.1,0.)), glm.vec3(0,1,0))

    red_arm = Node(base, glm.translate((.25, 0, .01)) * glm.scale((.25, .1, 0.)), glm.vec3(1,0,0))
    green_arm = Node(red_arm,  glm.translate((0.25, 0, .02)) * glm.scale((.25, .1, 0.)) , glm.vec3(0,1,0))
    ...
    while not glfwWindowShouldClose(window):
        ...
        #red_arm.set_transform(glm.translate((.2, 0, 0)) * glm.rotate(t, (0,0,1)))
        #green_arm.set_transform(glm.translate((.2, 0, 0)) * glm.rotate(t, (0,0,1)))
        red_arm.set_transform(glm.rotate(t, (0,0,1)))
        green_arm.set_transform(glm.translate((0.5, 0, 0)) * glm.rotate(t, (0,0,1)))
        ...
        draw_node(vao_box, green_arm, P*V, MVP_loc_box, color_loc_box)
        draw_node(vao_box, red_arm, P*V, MVP_loc_box, color_loc_box)
