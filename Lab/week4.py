...
def prepare_vao_line():
    ...
    vertices = glm.array(glm.float32,
        # position        # color
         -1.0, 0.0, 0.0,  1.0, 1.0, 1.0, # y-axis start
         1.0, 0.0, 0.0,  1.0, 1.0, 1.0, # y-axis end 
    )
...
def main():
    ...
    # prepare vaos
    vao_triangle1 = prepare_vao_triangle()
    vao_triangle2 = prepare_vao_triangle()
    ...
    while not glfwWindowShouldClose(window):
        ...
        # current frame: M
        glUniformMatrix3fv(M_loc, 1, GL_TRUE, M1)

        # draw triangle w.r.t. the current frame
        glBindVertexArray(vao_triangle1)
        glDrawArrays(GL_TRIANGLES, 0, 3)

        glUniformMatrix3fv(M_loc, 1, GL_TRUE, M2)
        glBindVertexArray(vao_triangle2)
        glDrawArrays(GL_TRIANGLES, 0, 3)
        
        glUniformMatrix3fv(M_loc, 1, GL_TRUE, M3)
